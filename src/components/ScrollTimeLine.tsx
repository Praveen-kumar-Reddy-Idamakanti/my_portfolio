...
export const ScrollTimeline = ({
  ...
  const inView = useInView(scrollRef, { once: true, margin: "-200px" });
  ...
  // Removed getCardVariants as we're using inline animations now
            ...
            <>
              ...
              <motion.div
                ...
                style={{
                  ...
                  background: `linear-gradient(to bottom,rgb(255, 255, 255),rgb(99, 241, 229),rgb(1, 146, 151))`,
                  // Enhanced shadow for a constant glow effect along the path
                  boxShadow: `
                    0 0 15px rgb(222, 222, 255),
                    0 0 25px rgb(222, 222, 255)
                  `,
                }}
              />
              ...
              >
                <motion.div
                  ...
                  style={{
                    background: 
                      "radial-gradient(circle, rgba(0, 183, 233, 0.8) 0%, rgb(0, 83, 156) 40%, rgb(0, 187, 244) 70%)",
                    // Intense, layered glow effect for the comet
                    boxShadow: `
                      0 0 15px 4px rgba(222, 222, 255, 0.6),
                      0 0 25px 8px rgba(31, 136, 160, 0.9),
                      0 0 40px 15px rgb(119, 206, 220)
                    `,
                  }}
                  animate={{
                    scale: [1, 1.3, 1],
            ...
            {events.map((event, index) => {
              return (
                ...
                >
                  ...
                  >
                    <Card className="dark bg-black border border-gray-800 text-white">
